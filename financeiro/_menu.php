...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-edit fa-2x"></i>Categoria<span class="fa arrow"></span></a>
            ...
            <li>
                <a href="#"><i class="fa fa-line-chart fa-2x"></i>Movimento<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="_menu.php?close=1"active-menu"><i class="fa fa-power-off fa-2x"></i>Sair</a>
            </li>
        </ul>
    </div>
</nav>